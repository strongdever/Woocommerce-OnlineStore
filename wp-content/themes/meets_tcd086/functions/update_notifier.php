...
?>
    ...
    <div class="wrap">
     	...
     	<div id="mono_instructions">
            ...
            <p style="font-size:16px;">【 <a href="https://dl.tcd-theme.com/tcd086/meets/meets_tcd086.zip"><?php _e( 'Download the latest version', 'tcd-w' ); ?></a> 】</p>
     		<div id="mono_info">
...
function get_latest_theme_version( $interval ) {
    ...
    $notifier_file_url = 'http://design-plus1.com/notifier_meets.xml';
    $db_cache_field = 'meets-contempo-notifier-cache';
    $db_cache_field_last_updated = 'meets-contempo-notifier-last-updated';
