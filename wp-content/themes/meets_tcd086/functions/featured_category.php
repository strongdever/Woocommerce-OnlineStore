...
// カテゴリー編集用入力欄を出力 -------------------------------------------------------
function featured_category_edit_extra_fields( $term ) {
...
// データを保存 -------------------------------------------------------
function featured_category_save_extra_fileds( $term_id ) {
  $new_meta = array();
...
add_action( 'edited_featured_category', 'featured_category_save_extra_fileds' );
