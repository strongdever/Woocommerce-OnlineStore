...
class CountryNormalizer implements \PYS_PRO_GLOBAL\FacebookAds\Object\CustomAudienceNormalizers\ValueNormalizerInterface
{
    /**
     * @param string $key
    ...
    {
        return $key === \PYS_PRO_GLOBAL\FacebookAds\Object\Fields\CustomAudienceMultikeySchemaFields::COUNTRY;
    }
    /**
     * @param string $key
     * @param string $key_value
    ...
    {
        return \substr(\preg_replace('/[^a-z]/', '', \strtolower(\trim($key_value))), 0, 2);
    }
}
