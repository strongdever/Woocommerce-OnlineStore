 ...
 *
 */
class VideoCopyrightFields extends \PYS_PRO_GLOBAL\FacebookAds\Enum\AbstractEnum
{
    ...
    {
        return array('content_category' => 'string', 'copyright_content_id' => 'string', 'creator' => 'User', 'excluded_ownership_segments' => 'list<VideoCopyrightSegment>', 'id' => 'string', 'in_conflict' => 'bool', 'monitoring_status' => 'string', 'monitoring_type' => 'string', 'ownership_countries' => 'VideoCopyrightGeoGate', 'reference_file' => 'CopyrightReferenceContainer', 'reference_file_disabled' => 'bool', 'reference_file_disabled_by_ops' => 'bool', 'reference_owner_id' => 'string', 'rule_ids' => 'list<VideoCopyrightRule>', 'tags' => 'list<string>', 'whitelisted_ids' => 'list<string>');
    }
}
