 ...
 **/
class CustomAudienceMultiKey extends \PYS_PRO_GLOBAL\FacebookAds\Object\AbstractCrudObject
{
    /**
     * @var string
     */
    ...
    {
        $warning_message = 'CustomAudienceMultiKey is being deprecated, please use' . '`new CustomAudience(...)->addUsers(..)` instead';
    ...
    {
        $warning_message = 'CustomAudienceMultiKey is being deprecated, please use' . '`new CustomAudience(...)->removeUsers(..)` instead';
        \trigger_error($warning_message, \E_USER_DEPRECATED);
        $params = $this->formatParams($users, $types, $is_hashed, $is_normalized);
