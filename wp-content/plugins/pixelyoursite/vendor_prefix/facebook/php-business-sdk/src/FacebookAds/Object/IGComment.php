 ...
 *
 */
class IGComment extends \PYS_PRO_GLOBAL\FacebookAds\Object\AbstractCrudObject
{
    /**
    ...
    {
        return \PYS_PRO_GLOBAL\FacebookAds\Object\Fields\IGCommentFields::getInstance();
    }
    ...
    public function createReply(array $fields = array(), array $params = array(), $pending = \false)
    {
        ...
        $enums = array();
        $request = new \PYS_PRO_GLOBAL\FacebookAds\ApiRequest($this->api, $this->data['id'], \PYS_PRO_GLOBAL\FacebookAds\Http\RequestInterface::METHOD_POST, '/replies', new \PYS_PRO_GLOBAL\FacebookAds\Object\IGComment(), 'EDGE', \PYS_PRO_GLOBAL\FacebookAds\Object\IGComment::getFieldsEnum()->getValues(), new \PYS_PRO_GLOBAL\FacebookAds\TypeChecker($param_types, $enums));
        $request->addParams($params);
        $request->addFields($fields);
        return $pending ? $request : $request->execute();
    }
    ...
    public function getSelf(array $fields = array(), array $params = array(), $pending = \false)
    {
        ...
        $param_types = array();
        $enums = array();
        $request = new \PYS_PRO_GLOBAL\FacebookAds\ApiRequest($this->api, $this->data['id'], \PYS_PRO_GLOBAL\FacebookAds\Http\RequestInterface::METHOD_GET, '/', new \PYS_PRO_GLOBAL\FacebookAds\Object\IGComment(), 'NODE', \PYS_PRO_GLOBAL\FacebookAds\Object\IGComment::getFieldsEnum()->getValues(), new \PYS_PRO_GLOBAL\FacebookAds\TypeChecker($param_types, $enums));
        $request->addParams($params);
        $request->addFields($fields);
        return $pending ? $request : $request->execute();
    }
