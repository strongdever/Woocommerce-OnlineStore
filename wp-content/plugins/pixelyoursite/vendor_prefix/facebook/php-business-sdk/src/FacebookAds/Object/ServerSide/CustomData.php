...
class CustomData implements \ArrayAccess
{
    ...
    public function normalize()
    {
        ...
        $normalized_payload['currency'] = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalize('currency', $this->getCurrency());
        ...
        $normalized_payload['delivery_category'] = \PYS_PRO_GLOBAL\FacebookAds\Object\ServerSide\Normalizer::normalize('delivery_category', $this->getDeliveryCategory());
