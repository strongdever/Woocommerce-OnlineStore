...
class MadidNormalizer implements \PYS_PRO_GLOBAL\FacebookAds\Object\CustomAudienceNormalizers\ValueNormalizerInterface
{
    /**
     * @param string $key
    ...
    {
        return $key === \PYS_PRO_GLOBAL\FacebookAds\Object\Fields\CustomAudienceMultikeySchemaFields::MADID;
    }
    /**
     * @param string $key
     * @param string $key_value
    ...
    {
        return \strtolower(\trim($key_value));
    }
}
