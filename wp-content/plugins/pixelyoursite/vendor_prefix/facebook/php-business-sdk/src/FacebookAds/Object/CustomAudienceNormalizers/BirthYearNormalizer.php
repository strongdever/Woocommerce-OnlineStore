...
class BirthYearNormalizer implements \PYS_PRO_GLOBAL\FacebookAds\Object\CustomAudienceNormalizers\ValueNormalizerInterface
{
    /**
     * @param string $key
    ...
    {
        return $key === \PYS_PRO_GLOBAL\FacebookAds\Object\Fields\CustomAudienceMultikeySchemaFields::BIRTH_YEAR;
    }
    /**
     * @param string $key
     * @param string $key_value
