...
echo '<div id="fkwcs-stripe-p24-payment-data" data-amount="' . esc_attr( Helper::get_stripe_amount( $total ) ) . '"	data-currency="' . esc_attr( strtolower( get_woocommerce_currency() ) ) . '">';
echo "<div class='fkwcs_stripe_p24_form'><div class='fkwcs_stripe_p24_select'></div></div>";
